...
class Home extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->library(array('session','pagination','twitterbootstrap','form_validation','pageslib'));
   ...
   public function article($slug){
    ...
    public function  a(){
      var_dump($this->home_model->allpost_from_category($parent_category,$offset,5));
    }
